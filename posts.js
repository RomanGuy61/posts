...
const POSTS = [
  {
   ...
   },
   {
      ...
      date: "2026-09-09",
      image: "images/SeptStat.png",
      excerpt: "More info on the game",
      content: "It’s been a while... This post was teased a while ago, but I completely forgot to actually make it. Better late than never, I guess!\n\nSo, what’s been happening with the tiny amount of leaks lately?\n\nHonestly, that was kinda my fault. I started working on a small side project that was supposed to be pretty simple, but it eventually turned into a MASSIVE project. I ended up spending way more time on it than I originally planned.\n\nThat project probably won’t ever be released, though, since it’s based around the layout of a real-life house. So unfortunately, there isn’t really much I can do with it publicly.\n\nANYWAY, enough about that. Let’s talk about BGP+.\n\nI’ve actually been working on V0.6A A LOT more than I’ve been teasing. I’m currently on V0.6A Dev5, and there’s already a lot more going on behind the scenes than you might think.\n\nFor starters, the themes. V0.5A/B only had the default 3 themes, but V0.6A is going to have WAY more than that. I’ve been working on adding more variety and making each theme feel more unique instead of just having a handful of options.\n\nAnd remember the secret door?\n\nYeah. It’s finally going to be OPENABLE in V0.6A. \n\nI’ve also made TONS of changes to the story. There are new story elements, changes to existing parts, and generally a lot more happening throughout the game. I’m trying to make the story feel much more fleshed out compared to previous versions.\n\nOh, and there’s a BASEMENT now...\n\nI think I can tease that.\n\nThere’s still a lot I’m keeping secret for now, but V0.6A is turning into a much bigger update than I originally expected.\n\nAnd there’s one more thing that I’ve been considering...\n\nMOBILE SUPPORT.\n\nYes, BGP+ might actually be playable on mobile at some point.\n\nThe only reason there might NOT be mobile support is because Unity and Bazzite seem to absolutely HATE each other whenever I try to build the game for Android. If I can get those issues sorted out, though, mobile support is definitely something I’d like to make happen.\n\nSo yeah, development is still going strong. Even though I haven’t posted many leaks lately, there has actually been a LOT happening behind the scenes.\n\nV0.6A Dev5 is currently in development, and there’s still plenty more that I haven’t shown yet.\n\nAnd yes...\n\nThe basement is real.",
   }
      ];
